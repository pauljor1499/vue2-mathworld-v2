...
export class STAAR_NewAssignment {
    getAllQuestions() {
    ...
    submit_Step2(selected_questions) {
        try {
            new_assignment.questions = JSON.parse(
    ...
    submit_Step3(start_date, end_date, class_assigned) {
        try {
            ...
            new_assignment.assigned_classes = JSON.parse(
