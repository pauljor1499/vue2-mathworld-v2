                ...
                questions: [
                    {
                        ...
                        flag: false,
                        question:
                            "Find the degree and constant term of the polynomial x4 + 7x3 - 2x.",
                        choices: [
                            {
                                id: 1,
...
export class AllClassesService {
    ...
    enroll_new_class(class_code) {
        if (this.class_exists(class_code)) {
            ...
            var index = all_classes.findIndex(
                (class_element) => class_element.code === class_code
            );
            if (index > -1) {
    ...
    class_exists(class_code) {
        var index = enrolled_classes.findIndex(
            (class_element) => class_element.code === class_code
        );
        if (index > -1) {
            return true;
