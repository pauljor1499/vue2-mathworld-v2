...
export class ProfilePageService {
    ...
    update_school_details(new_data) {
        const store_CurrentUser = storeCurrentUser();
        store_CurrentUser.current_user.credentials.school = new_data;
    }

    update_contact_person(new_data) {
        const store_CurrentUser = storeCurrentUser();
        store_CurrentUser.current_user.credentials.contact_person = new_data;
    }
