<template>
    <div class="answer-assignment" v-if="get_assignment !== ''">
        ...
        <v-dialog v-model="dialog" width="600px" persistent>
            <v-card>
                <v-card-title class="grey lighten-2"> Assignment Preview </v-card-title>
                <br />
                <v-card-text> This is only being done for testing and won't affect any information. </v-card-text>
                <v-divider></v-divider>
                <v-card-actions>
                    <v-spacer></v-spacer>
...
export default {
                ...
                questions: [
                    {
                        ...
                        choices: ["9 < M × N 9 < M × N9 < M × N9 < M × N9 < M × N", "x > 4", "9 > M × N", "10 < N × M"],
                        answer: {
                            student_answer: {
                                letter: "",
                                description: "",
...

                    {
                        ...
                        choices: ["The answer is 0.", "The answer is 1.", "The answer is 3.", "The answer is undefined."],
                        answer: {
                            student_answer: [],
                            test_answer: [],
                        },
    ...
    methods: {
        ...
        assignment_data() {
            var data = AssignmentService.prototype.get_assignment(this.$route.params.class_title, this.$route.params.assignment_code);
