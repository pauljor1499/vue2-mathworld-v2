        ...
        <v-card outlined class="main-card">
            <v-tabs v-model="tab">
                ...
                <v-tab>
                    ...
                    <v-badge
                        v-if="selected_questions.length != 0"
                        color="success"
                        inline
                        :content="selected_questions.length"
                    />
                </v-tab>
            </v-tabs>
...
export default {
    ...
    data() {
        return {
            edit_assignment: STAAR_EditAssignment.prototype.getEditAssignment(),
            get_questions: STAAR_EditAssignment.prototype.getAllQuestions(),
            all_questions: [],
            selected_questions: [],
            tab: null,
        };
    ...
    methods: {
        ...
        submit() {
            return STAAR_EditAssignment.prototype.submit_Step2(
