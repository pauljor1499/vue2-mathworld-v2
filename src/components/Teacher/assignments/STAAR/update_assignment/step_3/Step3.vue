                ...
                >
                    ...
                    <template v-slot:footer>
                        ...
                        <div class="date-picker-footer">
                            <v-btn text @click="new_data.range = null">
                                Clear
                            </v-btn>
                        </div>
                    </template>
...
export default {
    ...
    data() {
        return {
            ...
            items: STAAR_EditAssignment.prototype.get_all_classes(),
        };
    },
    ...
    methods: {
        ...
        getCurrentData() {
            ...
            for (
                var i = 0;
                i < this.edit_assignment.assigned_classes.length;
                i++
            ) {
                this.new_data.assigned_class.push(
                    this.edit_assignment.assigned_classes[i]
                );
            }
        },

        submit() {
            return STAAR_EditAssignment.prototype.submit_Step3(
                this.formatDate(this.new_data.range.start),
                this.formatDate(this.new_data.range.end),
