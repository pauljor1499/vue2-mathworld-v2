...
export default {
    ...
    methods: {
        ...
        submit() {
            return STAAR_EditAssignment.prototype.submit_Step1(this.new_data.title, this.new_data.description);
        },
    },
    ...
    created() {
        this.new_data.title = this.edit_assignment.title;
        this.new_data.description = this.edit_assignment.description;
    },
};
</script>
