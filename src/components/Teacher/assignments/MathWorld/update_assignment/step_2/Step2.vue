...
export default {
    ...
    data() {
        return {
            edit_assignment: MW_EditAssignment.prototype.getEditAssignment(),
            get_questions: MW_EditAssignment.prototype.getAllQuestions(),
            all_questions: [],
            selected_questions: [],
            tab: null,
        };
    ...
    methods: {
        ...
        getCurrentData() {
            var selected_questions = this.edit_assignment.questions;

            for (var i = 0; i < selected_questions.length; i++) {
                var index = this.all_questions.findIndex((item) => item.id === selected_questions[i].id);
        ...
        // submit() {
        //     return MW_EditAssignment.prototype.submit_Step2(this.selected_questions);
        // },
    },
