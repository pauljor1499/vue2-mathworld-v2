<template>
    <div class="main-content">
        ...
        <div class="content-title">
            <span class="class-name">New College Entrance Test</span>
            ...
            <v-stepper v-model="current_step">
                ...
                <v-stepper-items class="body-content">
                    ...
                    <v-stepper-content step="4">
                        <TSIStep4 @clickBack="clickBack()" @clickCreate="clickCreate()" />
                    </v-stepper-content>
                </v-stepper-items>
            </v-stepper>
        </div>
...
import TSIStep1 from "./step_1/Step1.vue";
import TSIStep2 from "./step_2/Step2.vue";
import TSIStep3 from "./step_3/Step3.vue";
import TSIStep4 from "./step_4/Step4.vue";
