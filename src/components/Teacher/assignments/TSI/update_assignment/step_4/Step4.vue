        ...
        <v-card outlined class="content-body">
            <div class="content-setup">
                ...
                <div class="item-1">
                    ...
                    <div class="item-body">
                        <ul
                            v-for="item in new_assignment.assigned_classes"
                            :key="item"
                        >
                            <li>{{ item }}</li>
                        </ul>
            ...
            <div
                ...
                v-if="new_assignment.questions.length != 0"
            >
                <div
                    v-for="(item, index) in new_assignment.questions"
                    :key="index"
                >
...
export default {
    ...
    data() {
        return {
            new_assignment: TSI_EditAssignment.prototype.getEditAssignment(),
        };
    },
    ...
    methods: {
        ...
        submit() {
            return TSI_EditAssignment.prototype.submit_Step4();
        },
    },
};
</script>
