<template>
    <div class="main-content">
        ...
        <div class="content-title">
            <span class="class-name">Edit College Entrance Test</span>
            ...
            <v-stepper v-model="current_step">
                ...
                <v-stepper-items class="body-content">
                    <v-stepper-content step="1">
                        <TSIStep1 @clickCancel="clickCancel()" @clickNext="clickNext()" />
                    </v-stepper-content>
                    <v-stepper-content step="2">
                        <TSIStep2 @clickBack="clickBack()" @clickNext="clickNext()" />
                    </v-stepper-content>
                    <v-stepper-content step="3">
                        <TSIStep3 @clickBack="clickBack()" @clickNext="clickNext()" />
                    </v-stepper-content>
                    <v-stepper-content step="4">
                        <TSIStep4 @clickBack="clickBack()" @clickUpdate="clickUpdate()" />
                    </v-stepper-content>
                </v-stepper-items>
            </v-stepper>
        </div>
...
import TSIStep1 from "../update_assignment/step_1/Step1.vue";
import TSIStep2 from "../update_assignment/step_2/Step2.vue";
import TSIStep3 from "../update_assignment/step_3/Step3.vue";
import TSIStep4 from "../update_assignment/step_4/Step4.vue";
...
export default {
    ...
    created() {
        TSI_EditAssignment.prototype.set_assignment(this.$route.params.class_title, this.$route.params.assignment_code);
    },
};
</script>
