            ...
            <div class="question-content">
                <v-card>
                    ...
                    <v-card-text class="question-body">
                        ...
                        <div class="choices">
                            <div
                                v-for="(choice, index) in get_assignment
                                    .questions[current_question].choices"
                                :key="index"
                                :class="{
                                    'choices-item': true,
                                    'choices-item-red':
                                        (choice.id === get_test_answer() &&
                                            choice.id !==
                                                get_student_answer()) ||
...
export default {
    ...
    computed: {
        get_assignment() {
            return AssignmentService.prototype.get_assignment(
                this.class_title,
    ...
    methods: {
        ...
        get_total_score() {
            ...
            this.get_assignment.questions.forEach((question) => {
                if (question.answer.student !== "")
                    if (question.answer.student.id === question.answer.test.id)
        ...
        get_student_answer() {
            var answer = 0;
            if (
                this.get_assignment.questions[this.current_question].answer
                    .student !== ""
            ) {
                answer =
                    this.get_assignment.questions[this.current_question].answer
        ...
        get_test_answer() {
            return this.get_assignment.questions[this.current_question].answer
                .test.id;
        },
    },
