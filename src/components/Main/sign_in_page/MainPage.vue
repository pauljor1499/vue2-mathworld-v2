        ...
        async submit() {
            ...
            if (!this.hasErrors()) {
                ...
                if (this.select == "Teacher") {
                    this.loading = true;
                    const result = await this.teacher_store.login_teacher(
                        credentials
                    );
                    ...
                    this.loading = true;
                    const result = await this.student_store.login_student(
                        credentials
                    );
                    this.loading = this.teacher_store.loading;
                    if (result == true) {
