    ...
    computed: {
        first_nameErrors() {
            ...
            !this.$v.user.first_name.maxLength &&
                errors.push("First name may not be longer than 25 characters");
        ...
        middle_nameErrors() {
            ...
            !this.$v.user.middle_name.maxLength &&
                errors.push("Middle name may not be longer than 25 characters");
            return errors;
        },
        ...
        last_nameErrors() {
            ...
            !this.$v.user.last_name.maxLength &&
                errors.push("Last name may not be longer than 25 characters");
        ...
        schoolErrors() {
            ...
            !this.$v.user.school.maxLength &&
                errors.push("School may not be longer than 35 characters");
        ...
        emailErrors() {
            ...
            !this.$v.user.email.maxLength &&
                errors.push("E-mail may not be longer than 25 characters");
        ...
        passwordErrors() {
            ...
            !this.$v.user.password.maxLength &&
                errors.push("Password may not be longer than 25 characters");
        ...
        relationshipErrors() {
            ...
            !this.$v.contact.relationship.maxLength &&
                errors.push(
                    "Relationship may not be longer than 25 characters"
                );
        ...
        streetErrors() {
            ...
            !this.$v.contact.street.maxLength &&
                errors.push("Street may not be longer than 25 characters");
        ...
        zip_codeErrors() {
            ...
            if (
                this.contact.zip_code.length == 5 ||
                this.contact.zip_code.length == 9
            ) {
                errors.length = 0;
            } else {
        ...
        async submit() {
            ...
            if (!this.hasErrors()) {
                if (this.user.role === "Teacher") {
                    const isVerified = TeacherService.prototype.verify_teacher(
                        this.user
                    );
                    if (isVerified) {
                        ...
                        this.error.status = true;
                        this.error.message =
                            "The provided email is not a client email. Please use your school email instead.";
                    }
                } else if (this.user.role === "Student") {
                    const response = await this.register_student(
                        this.user,
                        this.contact
                    );
